...
import static com.youtubebing.stealthplayer.youtube.YouTubeSingleton.getInstance;

/**
 * Created by smedic on 5.3.17..
 */

public class YouTubePlaylistVideosLoader extends AsyncTaskLoader<List<VideoItem>> {
    ...
    public List<VideoItem> loadInBackground() {
        ...
        List<VideoItem> playlistItems = new ArrayList<>();
        String nextToken = "";
        ...
        while (pit.hasNext()) {
            ...
            VideoItem youTubeVideo = new VideoItem();

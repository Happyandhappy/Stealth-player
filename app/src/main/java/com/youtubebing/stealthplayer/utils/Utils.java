...
public class Utils {
     ...
     * @param videos
     */
    public static void prettyPrintVideos(List<VideoItem> videos) {
        Log.d(TAG, "=============================================================");
        Log.d(TAG, "\t\tTotal Videos: " + videos.size());
        Log.d(TAG, "=============================================================\n");

        Iterator<VideoItem> playlistEntries = videos.iterator();

        while (playlistEntries.hasNext()) {
            VideoItem playlistItem = playlistEntries.next();
     ...
     * @param playlistEntry
     */
    public static void prettyPrintVideoItem(VideoItem playlistEntry) {
        Log.d(TAG, "*************************************************************");
        Log.d(TAG, "\t\tItem:");
        Log.d(TAG, "*************************************************************");

...
public class DetailAdapter extends RecyclerView.Adapter<DetailAdapter.CustomHolder>
    ...
    public DetailAdapter(Context context, List<VideoItem> list){
    ...
    public void onClick(View v) {
        if (itemEventsListener != null) {
            ...
            itemEventsListener.onItemClick1(item);
        }
    }
